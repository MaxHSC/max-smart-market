...
class ProductsServices():
    ...
    def confirm_payment_order(self,order_number,total_order_price,inserted_value) -> bool:
        confirm_payment = pay_gat.confirm_payment(total_order_price,inserted_value)

        return confirm_payment

    def restore_order(self,order_number: int, user_id: int) -> list:
    ...
    def mount_token_payload(self,order_token: str, expires_token: datetime, cabinet_id_list: list) -> bytes:


    def send_token_to_cabinet(order_token: str, expires_token: datetime, cabinet_list: list):